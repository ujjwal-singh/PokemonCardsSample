...
public class MainActivity extends AppCompatActivity
    ...
    /** Username validity information button. */
    private Button usernameValidityInfoButton;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        usernameValidityInfoButton = (Button) this.findViewById(R.id.
                usernameValidityInfo);
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.usernameValidityInfo:
                usernameValidityDialog();
                break;
    ...
    /**
     *  This method displays a dialog containing information
     *  about validity of username.
     */
    private void usernameValidityDialog() {

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(R.string.usernameHintDialogTitle)
                .setMessage(R.string.usernameHintDialogMessage)
